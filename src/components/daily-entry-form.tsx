...
export function DailyEntryForm({
  ...
  /** The participant's own approved plan, when they have been assigned one. */
  dietPlanNote?: string;
}) {
  ...
  return (
    <form action={action} className="space-y-8">
      ...
      {/* ---- diet: five eating occasions, two points each ---- */}
      <section className="space-y-3">
        <div className="flex items-baseline justify-between gap-3">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          {dietPlanNote ??
            "Two points for each eating occasion you followed your approved BCJ plan. Ten in total, every day."}
        </p>
